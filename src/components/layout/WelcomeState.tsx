  ...
  return (
    <div class="welcome-state">
        ...
        >
          ...
          <div class="welcome-import-card-body">
            ...
            <span class="welcome-import-card-sub">
              Explore all {pairCount.toLocaleString()} study pairs in the FLoRA Explorer
            </span>
          </div>
          <svg class="welcome-import-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="9 18 15 12 9 6" />
      ...
      <p class="welcome-footnote">
        ...
        (FLoRA), the Replication Atlas covers {pairCount.toLocaleString()}{" "}
        pairings of an original finding with a replication or reproduction
        attempt, across research disciplines.
      </p>
