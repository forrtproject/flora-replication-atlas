...
export const ReplicationActionsPanel = (
  props: ReplicationActionsPanelProps,
) => {
    ...
    <div class="mt-8 border border-gray-200 no-print">
      <div class="navbar min-h-0 flex-wrap">
        <div class="navbar-start p-0 w-auto flex-1 flex-wrap">
          <button
            tabIndex={-1}
            class="btn btn-sm btn-ghost mr-2 pointer-events-none"
          >
        ...
        <div class="navbar-end p-0 gap-2 w-auto flex-1 flex-wrap">
          <div class="join">
            <div class="relative inline-flex">
              <button class="btn btn-sm join-item" onClick={handleTextCopy}>
            ...
            <div class="relative inline-flex">
              <button class="btn btn-sm join-item" onClick={handleLinkCopy}>
            ...
            <a
              ...
              href={`https://pubpeer.com/search?q=${props.data.doi}`}
              target="_blank"
            >
          ...
          <a
            class="btn btn-sm"
            href={`mailto:lukas.roeseler@uni-muenster.de?subject=[Replication Flag] ${props.data.doi}&body=I would like to flag a potential issue in the replication record for:%0AOriginal DOI: ${props.data.doi}%0AReplication DOI: ${props.data.doi}%0AIssue details: [your comment here]`}
          >
            <FlagIcon className="w-5 h-5" /> Flag Errors
          </a>
          <a
            class="btn btn-sm"
            href={`https://docs.google.com/forms/d/e/1FAIpQLSeMCwdtP0TPgL55stniuyyTxnNwyC34mO4VUuLcQwYrLI89sQ/viewform?usp=pp_url&entry.1234567890=${encodeURIComponent(props.data.doi || "")}`}
            target="_blank"
          >
